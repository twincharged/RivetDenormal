class CreateUserRelations < ActiveRecord::Migration
  def change
    create_table :user_relations do |t|
      ...
      t.integer :owned_event_ids,         array: true, default: []
      t.integer :owned_group_ids,         array: true, default: []
 
      t.integer :added_event_ids,         array: true, default: []
      t.integer :invited_event_ids,       array: true, default: []
      ...
      # t.integer :sparked_post_ids,        array: true, default: []     #=> Not nesccessary. Index via GIN if so.
